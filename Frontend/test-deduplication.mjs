...
async function runCandidateTests() {
  ...
  // Case A: Near Pothole at St. Andrew's School (Should DETECT DUPLICATE)
  const candidateDuplicate = {
    id: "NEW-001",
    category: "pothole",
    coords: [19.0559, 72.8296], // ~15m from CIVIC-2026-8921 ([19.0558, 72.8295])
    phash: "a1b2c3d4e5f60719"   // 1 bit off CIVIC-2026-8921's hash
  };
  ...
  const candidateFarAway = {
    id: "NEW-003",
    category: "pothole",
    coords: [19.0600, 72.8350], // ~700m away
